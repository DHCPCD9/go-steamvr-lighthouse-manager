...
import { GetFoundBaseStations } from "../../wailsjs/go/main/App";
...
export function BaseStationSettings({ station }) {
    ...
    return (<div className="text-white poppins-regular px-[24px]">
        <div className="bg-[#1F1F1F] min-h-[70px] py-[12px] px-[8px] rounded-[6px] flex flex-col justify-between items-center">
            ...
            <AnimatePresence>
                {channelChangeActive && <motion.div key={"channels"} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-row items-center max-w-full py-[6px] gap-[3px]">
